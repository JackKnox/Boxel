...
typedef enum box_render_data_type {
	BOX_RENDER_DATA_TYPE_SINT8,
	BOX_RENDER_DATA_TYPE_SINT16,
	BOX_RENDER_DATA_TYPE_SINT32,
	
	BOX_RENDER_DATA_TYPE_UINT8,
	BOX_RENDER_DATA_TYPE_UINT16,
	BOX_RENDER_DATA_TYPE_UINT32,
	
	BOX_RENDER_DATA_TYPE_FLOAT32,
	
	BOX_RENDER_DATA_TYPE_BOOL,
} box_render_data_type;
...
typedef struct box_render_layout {
	...
	box_render_data_type index_type;
