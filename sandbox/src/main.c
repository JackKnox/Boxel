...
int main(int argc, char** argv) {
	...
	box_render_layout_add_descriptor(&layout, BOX_DESCRIPTOR_TYPE_IMAGE_SAMPLER, BOX_SHADER_STAGE_TYPE_FRAGMENT); // Binding = 0
	...
	box_renderstage* renderstage = 
		box_engine_create_graphics_stage(engine, &layout, graphics_shaders, BX_ARRAYSIZE(graphics_shaders), BOX_VERTEX_TOPOLOGY_TRIANGLES, vert_buffer, index_buffer);
